...
This correction supersedes any earlier wording that implied fixed instruction classes for 'Slot A' and 'Slot B'. Aurora uses two largely symmetric issue lanes. Ordinary scalar, packed, shuffle, address, and control instructions may issue from either lane when dependencies and resources permit.
